  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    ...
    <div class="flex justify-center mb-12">
      <div class="bg-gray-100 dark:bg-gray-800 rounded-lg p-1">
        ...
        >
          Yearly
          <span class="ml-1 text-xs bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 px-2 py-1 rounded-full">
            Save 20%
          </span>
        </button>
      </div>
        ...
        <div class="text-center">
          ...
          <div class="mb-8">
            <span class="text-4xl font-bold text-gray-900 dark:text-white">
              ${{ billingPeriod === 'yearly' ? '8' : '10' }}
            </span>
            <span class="text-gray-600 dark:text-gray-300">/month</span>
            <span v-if="billingPeriod === 'yearly'" class="text-sm text-green-600 dark:text-green-400 ml-2">
              (billed yearly)
            </span>
          </div>
        </div>
...
const selectPlan = async (plan) => {
  ...
  try {
    const priceId = plan === 'pro' 
      ? (billingPeriod.value === 'yearly' ? 'price_pro_yearly' : 'price_pro_monthly')
